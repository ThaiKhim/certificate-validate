...
var modal = {
	...
	"social.sms-placeholder-text": "Eg: ",
...
class LoginModal extends SafeEventEmitter {
  constructor(_ref) {
    ...
    this.initModal = () => __awaiter(this, void 0, void 0, function* () {
      ...
      if (useLang === "de") {
        import('./german-8ac772ab.js').then(messages => {
        ...
        import('./japanese-cea7c27a.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./korean-bd41750a.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./mandarin-b48cd662.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./spanish-2f089950.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./french-056edcff.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./portuguese-c3c46b96.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
